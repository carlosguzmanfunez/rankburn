...
export function AdvertiseFlow() {
  const { companies, ownedId, checkoutEnabled } = useMarket()
  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-md text-sm leading-relaxed text-muted-foreground">
        Your active advertising budget determines placement and is gradually
        used while your campaign receives exposure. Higher active advertising
        budget means higher placement under the published ranking rules.
      </p>
