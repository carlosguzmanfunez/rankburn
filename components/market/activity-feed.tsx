...
// Keys must cover every member of `ActivityKind`. `added` was the RankBurn-era
// "added budget" event; Beta 2.0 replaced it with `boosted`, which reports a
// Burn Rate increase.
const ICON = {
  took: Crown,
  boosted: Plus,
